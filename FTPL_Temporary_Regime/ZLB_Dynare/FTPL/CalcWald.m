function [nsims, pvalue_novar, Wald_novar, Trans_Wald_novar, mean_var_sims] = CalcWald(data,coef)
try
...
warning off
[M_ZLB, oo_ZLB] = driver_function_zlb(coef,rho_est);
...
% dynare orthodox.mod noclearall nopreprocessoroutput notime;    
[M_, oo_] = driver_function(coef,rho_est);
[M_ZLB, oo_ZLB] = driver_function_zlb(coef,rho_est_ZLB);
warning on
...
warning off
[boots_data, NKweight_output,nsims,NB_Tall] = Boots_data_endog_switching_parallel_ZLB_ftpl(act_data,nvars,inno,inno_ZLB,nboot,start_lagged_pinf,coef,rho_est,rho_est_ZLB,NBbase);
%%   
if nsims < 300
    pvalue_novar=0;
    Wald_novar=3000;
