function [ YY, NKweight_output,nsims, NB_Tall] = Boots_data_endog_switching_parallel_ZLB_ftpl(act_data,nvars,inno,inno_ZLB,nboot,start_lagged_pinf,coef,rho_est,rho_est_ZLB,NBbase)
%Input:
