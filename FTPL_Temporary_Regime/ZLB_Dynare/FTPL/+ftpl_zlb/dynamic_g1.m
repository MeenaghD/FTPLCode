...
if T_flag
    T = ftpl_zlb.dynamic_g1_tt(T, y, x, params, steady_state, it_);
end
g1 = zeros(34, 78);
g1(1,45)=1;
g1(1,78)=(-1);
...
g1(4,2)=(-T(1));
g1(4,28)=1;
g1(4,61)=(-(params(14)*params(6)*T(1)));
g1(4,29)=(-(T(1)*1/(params(6)*params(6)*params(26))));
g1(4,49)=(-1);
g1(5,29)=1;
g1(5,62)=(-T(3));
g1(5,64)=(-T(2));
...
g1(8,31)=(-(T(5)*(-((1+params(14)*params(6)*params(32))/(1+params(14)*params(6))))));
g1(8,6)=(-(T(1)*T(5)));
g1(8,63)=(-(T(5)*T(6)));
g1(8,7)=(-(T(5)*T(4)*(-T(8))));
g1(8,33)=(-(T(5)*T(4)*T(7)));
g1(8,35)=(-(T(5)*T(4)*params(30)));
g1(8,43)=1;
g1(8,45)=(-(T(5)*T(6)));
g1(8,53)=(-T(5));
g1(9,31)=1;
...
g1(14,31)=(-(params(42)*(1+params(14)*params(6)*params(33))/T(11)/params(40)));
g1(14,32)=(-(params(42)*(-(1-params(40)))/params(40)+(1-params(42))*(-((1-params(40))/params(40)))));
g1(14,36)=1;
g1(14,45)=(-(params(42)*(-(params(14)*params(6)))/T(11)/params(40)));
g1(14,51)=(-(params(42)*1/params(40)+(1-params(42))*1/params(40)));
g1(14,52)=(-(params(42)*(-(1+params(14)*params(6)*params(33)))/T(11)/params(40)));
g1(15,29)=(-params(43));
g1(15,30)=(-params(43));
g1(15,37)=1;
g1(15,39)=params(43);
