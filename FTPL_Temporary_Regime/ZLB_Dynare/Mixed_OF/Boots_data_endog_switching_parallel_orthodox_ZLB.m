function [ YY, NKweight_output] = Boots_data_endog_switching_parallel_orthodox_ZLB(act_data,nvars,inno,inno_ZLB,nboot,start_lagged_pinf,coef,rho_est,rho_est_ZLB)
%Input:
