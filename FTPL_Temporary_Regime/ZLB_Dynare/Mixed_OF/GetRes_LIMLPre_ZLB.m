function [residual,residual_dt,inno,rho_est,nst_inx] = GetRes_LIMLPre_ZLB(M_,endo,inx_expect,inx_eqs)
...
for t=1:T;
    [residual(:,t), g1, g2, g3] = eval([ 'orthodox_zlb.dynamic(y(:,t), x, M_.params, 0, t)']);
end
  if isempty(inx_eqs)
