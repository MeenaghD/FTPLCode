...
if T_flag
    T = orthodox_zlb.static_g1_tt(T, y, x, params);
end
g1 = zeros(34, 34);
g1(1,5)=(-1);
g1(1,19)=1;
g1(2,12)=(-1);
g1(2,20)=1;
g1(4,3)=(-(T(1)*1/(params(6)*params(6)*params(26))));
g1(4,23)=(-1);
g1(5,3)=1-T(3);
g1(5,10)=(-T(2));
g1(5,12)=1;
...
g1(8,5)=(-(T(5)*(params(32)/(1+params(14)*params(6))-(1+params(14)*params(6)*params(32))/(1+params(14)*params(6)))));
g1(8,6)=(-(T(5)*(T(1)+T(6))));
g1(8,7)=(-(T(5)*T(4)*(T(7)-T(8))));
g1(8,9)=(-(T(5)*T(4)*params(30)));
g1(8,17)=1;
g1(8,19)=(-(T(5)*T(6)));
g1(8,27)=(-T(5));
g1(9,5)=1;
...
g1(13,9)=1;
g1(13,10)=(-(1+T(10)));
g1(14,5)=(-(params(42)*(1+params(14)*params(6)*params(33)-params(33))/T(11)/params(40)));
g1(14,6)=(-(params(42)*(-(1-params(40)))/params(40)+(1-params(42))*(-((1-params(40))/params(40)))));
g1(14,10)=1;
g1(14,19)=(-(params(42)*(-(params(14)*params(6)))/T(11)/params(40)));
g1(14,25)=(-(params(42)*1/params(40)+(1-params(42))*1/params(40)));
g1(14,26)=(-(params(42)*(-(1+params(14)*params(6)*params(33)))/T(11)/params(40)));
g1(15,3)=(-params(43));
g1(15,4)=(-params(43));
g1(15,11)=1;
g1(15,13)=params(43);
