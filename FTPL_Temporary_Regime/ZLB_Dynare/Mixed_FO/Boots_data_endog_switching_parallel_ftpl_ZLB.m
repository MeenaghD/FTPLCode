function [ YY, NKweight_output,nsims, NB_Tall] = Boots_data_endog_switching_parallel_ftpl_ZLB(act_dataPre,nvars,inno,inno_ZLB,nboot,start_lagged_pinf,coef,rho_est,rho_est_ZLB,NBbase)
%Input:
...
% Create a reproducible random stream unique to this iteration
    ...
    for t = 3:T 
        ...
        if t==3
            r5(1,1:T+49)=act_dataPre(1,t);
            pinf(1,1:T+49)=act_dataPre(5,t);
        else
            for t1=t:T+49
