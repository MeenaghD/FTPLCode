function [pvalue_novar, Wald_novar, Trans_Wald_novar, mean_var_sims] = CalcWald(data,coef)
try
...
warning off
[boots_data, NKweight_output] = Boots_data_endog_switching_parallel_ZLB(act_data,nvars,inno,inno_ZLB,nboot,start_lagged_pinf,coef,rho_est,rho_est_ZLB);
%%   
% Step3:
