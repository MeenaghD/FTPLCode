...
[boots_data, NKweight_output,nsims,NB_Tall] = Boots_data_endog_switching_parallel_ftpl(act_data,nvars,inno,nboot,start_lagged_pinf,coef,rho_est,NBbase);
%%   
if nsims < 300
    pvalue_novar=0;
    Wald_novar=3000;
...
[pvalue, Wald, Trans_Wald, mmetric, all_coeffs, act_coeffs, mean_var_sims] = Wald_nonstationary(act_data(var_no,:),boots_data(var_no,:,:),act_nonstatResid,boots_nonstatResid,rho_nonstat,var_order,var_variance);
