...
% Surplus is an ARIMA(1,0,0), do this separately
surplus=(data(:,32))';
[rho_surp, surp_inno] = Vare(surplus,1,[]);   
rho_est(13)=rho_surp;
inno(12,:)=[surp_inno];
...
[boots_data, NKweight_output,nsims,NB_Tall] = Boots_data_endog_switching_parallel_ftpl(act_data,nvars,inno,nboot,start_lagged_pinf,coef,rho_est,NBbase,nomGDPbase);
%%   
if nsims < 300
    pvalue_novar=0;
    Wald_novar=3000;
