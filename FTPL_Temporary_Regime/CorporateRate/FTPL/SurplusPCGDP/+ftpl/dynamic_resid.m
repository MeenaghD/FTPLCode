...
residual = zeros(33, 1);
    ...
    residual(4) = (y(28)) - (T(4)*(y(2)+params(6)*params(14)*y(60)+1/(params(6)*params(6)*params(26))*y(29))+y(49));
    residual(5) = (y(29)) - (T(5)*y(65)-y(66)+T(6)*y(61));
    ...
    residual(9) = (y(44)) - (T(10)-(y(31)-y(45))+y(54));
    ...
    residual(17) = (y(39)) - (1.7*y(40)-0.7*y(13)+0.99*y(10)+y(56));
    ...
    residual(21) = (y(47)) - (params(54)*y(14)+params(55)*x(it_, 5)+x(it_, 1));
    residual(22) = (y(48)) - (params(56)*y(15)+x(it_, 2));
    residual(23) = (y(49)) - (params(57)*y(16)+x(it_, 3));
    residual(24) = (y(50)) - (params(58)*y(17)+x(it_, 4));
    residual(25) = (y(51)) - (x(it_, 5)+y(18)+params(59)*(y(18)-y(26)));
    residual(26) = (y(52)) - (params(60)*y(19)+x(it_, 6));
    residual(27) = (y(53)) - (params(61)*y(20)+x(it_, 7));
    residual(28) = (y(54)) - (params(62)*y(21)+x(it_, 8));
    residual(29) = (y(55)) - (params(63)*y(22)+x(it_, 9));
    residual(30) = (y(56)) - (params(64)*y(23)+x(it_, 10));
    residual(31) = (y(57)) - (params(65)*y(24)+x(it_, 11));
    residual(32) = (y(58)) - (params(66)*y(25)+x(it_, 12));
    residual(33) = (y(59)) - (y(18));
