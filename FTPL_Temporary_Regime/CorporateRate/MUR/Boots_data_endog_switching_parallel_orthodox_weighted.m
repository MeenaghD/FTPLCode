function [ YY, NKweight_output,nsims, NB_Tall, debtgdp2_all, all_coef25] = Boots_data_endog_switching_parallel_orthodox_weighted(act_data,nvars,inno,nboot,start_lagged_pinf,coef,rho_est,NBbase,nomgdp)
%Input:
