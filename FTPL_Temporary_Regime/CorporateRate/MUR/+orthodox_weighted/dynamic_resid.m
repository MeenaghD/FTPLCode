...
if T_flag
    T = orthodox_weighted.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(34, 1);
    residual(1) = (y(46)) - (params(50)*x(it_, 13)+(1-params(50))*y(64));
    residual(2) = (y(47)) - (y(69));
    residual(3) = (y(28)) - (y(46)+T(2)*(T(1)/(1+T(1))*y(7)+1/(1+T(1))*y(66)+T(3)*(y(36)-y(67))+y(49)-y(34)));
    residual(4) = (y(29)) - (T(4)*(y(2)+params(6)*params(14)*y(62)+1/(params(6)*params(6)*params(26))*y(30))+y(50));
    residual(5) = (y(30)) - (T(5)*y(68)-y(69)+T(6)*y(63));
    ...
    residual(8) = (y(44)) - (T(8)*(T(4)*y(6)+T(9)*y(65)+params(32)/(1+params(6)*params(14))*y(5)-y(32)*(1+params(6)*params(14)*params(32))/(1+params(6)*params(14))+y(46)*T(9)+T(7)*T(10)+y(54)));
