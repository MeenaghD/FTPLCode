function [pvalue_novar, Wald_novar, Trans_Wald_novar, mean_var_sims, nsims] = CalcWaldMix_FO(dataAll,dataPre,dataPost,coefPre,coefPost)
try
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
% dynare orthodox.mod noclearall nopreprocessoroutput notime;    
[M_Post, oo_Post] = driver_function_orthodox(coefPost,rho_estPost);
...
[boots_data, NKweight_output,nsims] = Boots_data_endog_switching_parallel_mix_FO(act_dataPre,act_dataPost,nvarsPre,nvarsPost,innoPre,innoPost,nboot,start_lagged_pinf,coefPre,coefPost,rho_estPre,rho_estPost,NBbase);
%%   
if nsims < 300
    pvalue_novar=0;
    Wald_novar=3000;
